...
CREATE UNIQUE INDEX yggc_authorization_codes_uid_key ON __PREFIX__yggc_authorization_codes (uid) WHERE uid IS NOT NULL;
...
CREATE UNIQUE INDEX yggc_device_codes_uid_key ON __PREFIX__yggc_device_codes (uid) WHERE uid IS NOT NULL;
...
CREATE UNIQUE INDEX yggc_refresh_tokens_uid_key ON __PREFIX__yggc_refresh_tokens (uid) WHERE uid IS NOT NULL;
...
CREATE UNIQUE INDEX yggc_grants_uid_key ON __PREFIX__yggc_grants (uid) WHERE uid IS NOT NULL;
...
CREATE UNIQUE INDEX yggc_interactions_uid_key ON __PREFIX__yggc_interactions (uid) WHERE uid IS NOT NULL;
...
CREATE UNIQUE INDEX yggc_sessions_uid_key ON __PREFIX__yggc_sessions (uid) WHERE uid IS NOT NULL;
